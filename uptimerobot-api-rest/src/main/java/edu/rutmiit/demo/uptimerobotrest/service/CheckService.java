...
public class CheckService {
        ...
        public PagedResponse<CheckResponse> findAll(Long checkId, OffsetDateTime date, String url,
        ...
        public CheckResponse create(CheckRequest request) {
                ...
                CheckResponse check = CheckResponse.builder().id(id).name(request.name())
        ...
        public void delete(Long id) {
                ...
                storage.alerts.values().removeIf(a -> a.getCheck() != null
        ...
        public CheckResponse runCheckNow(Long id) {
                ...
                CheckResponse updated = CheckResponse.builder().id(existing.getId())
                                .name(existing.getName()).method(existing.getMethod())
